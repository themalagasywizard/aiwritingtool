...
function setupDarkModeToggle(storageKey = 'theme') {
  ...
  window.toggleDarkMode = function() {
    ...
    console.log('Dark mode state:', isDarkMode ? 'enabled' : 'disabled');
    ...
    if (darkModeSwitch) {
      console.log('Setting darkModeSwitch checked to:', isDarkMode);
      // Use this approach to avoid triggering the change event again
      if (darkModeSwitch.checked !== isDarkMode) {
